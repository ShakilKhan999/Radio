...
class MyStoreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(()=>homeController.mystorepagestate==0?Scaffold(
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: [
                Container(
                    height: 50.h,
                    width: (MediaQuery.of(context).size.width - 65) / 2 - 5,
                    decoration: BoxDecoration(
                ...
                Container(
                    height: 50.h,
                    width: (MediaQuery.of(context).size.width - 65) / 2 - 3,
                    decoration: BoxDecoration(
                        border: Border.all(color: Colors.grey),
                        color: Colors.black,
                        borderRadius: BorderRadius.circular(5)),
          ...
          Container(
            ...
            child: ElevatedButton(onPressed: (){
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.logout),
                    Text('Logout',style: TextStyle(color: Colors.white,fontSize: 20.sp),),
                  ],
                )),
          ),
          SizedBox(
          ...
          Container(
            ...
            child: ElevatedButton(onPressed: (){
              showDialog(
                ...
                child: Text('Withdraw',style: TextStyle(color: Colors.white,fontSize: 20.sp),)),
          ),
        ],
      ),
    ):ProfileEditWidget());
