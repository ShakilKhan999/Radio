  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(onPressed: (){
        ...
        label: Text('Publish News'),backgroundColor:Color(0xffffEA1C24),),
    );
  }
}
...
class NewsCard extends StatelessWidget {
  ...
  NewsCard({required this.imageUrl,
    required this.title, required this.subtitle,required this.subImage,
          ...
          child: Stack(
            children: [
                ...
                children: [
                  Container(
                    ...
                    child: Transform.scale(
                      scale: 0.9, // Adjust the scale factor to decrease the image size
                      child: ClipRRect(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Image.asset(subImage,height: 5.h,width: 5.w,),
                            SizedBox(width: 3.0.w),
                            Text(
                              subtitle1,
                              style: TextStyle(
              ...
              Positioned(
                ...
                left: 6.0,
                child: Image.asset(
                  'images/newslogo.png', // Replace with the actual path to your logo image
                  width: 20.0,
                  height: 20.0,
                ),
              ),
